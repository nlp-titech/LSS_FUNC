...
model_save_path = '{}/output/train_bi-encoder-mnrl-{}-margin_{:.1f}-{}'.format(args.out_dir, model_name.replace("/", "-"), ce_score_margin, datetime.now().strftime("%Y-%m-%d_%H-%M-%S"))
...
hard_negatives_filepath = os.path.join(data_folder, 'msmarco-hard-negatives-msmarco.jsonl.gz')
