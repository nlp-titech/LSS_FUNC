...
result_dir=$root_dir/$dataset/result/lss-512-${window_size}/$model_type
...
then
  model_name_or_path=/groups/gcb50243/iida.h/BEIR/model/output/bert-base-uncased-v3-msmarco-2022-02-19_08-25-11
  tok_dim=768
